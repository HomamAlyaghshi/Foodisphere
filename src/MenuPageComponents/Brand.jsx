...
const Brand = () => {
  return (
    <div className='flex w-full h-full bg-gray-100 py-24 mt-16 justify-around items-center'>
        <div className='grid w-full sm:w-1/3 font-playfair text-themeColor   justify-center items-center gap-10 mx-10'>
            <h1 className='sm:text-4xl text-2xl text-center whitespace-nowrap'>You can order through apps</h1>
        ...
        <div className='w-2/3 h-full grid-cols-3  justify-center items-center hidden sm:flex gap-8'>
