...
const Footer = () => {
  return (
    <div className="">
      ...
      >
        <aside className="text-themeColor">
        ...
        <nav>
          ...
          <div className="sm:flex grid grid-cols-2 gap-2 justify-center items-center mt-4">
            <h1 className="font-playfair text-2xl text-themeColor">
              Visit us on Instagram see more
            </h1>
            <QRCodeGenerator
              linkQR={
                "https://www.instagram.com/homam_yaghshi/profilecard/?igsh=YTB4dXN2ZDV3cWE0"
              }
            />
          </div>
        </nav>
